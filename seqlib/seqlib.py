...
class Seqlib():
    ...
    # private functions used only during inti -----
    def _mutate(base):
    ...
    def _get_maf(self):
        ...
        for col in range(self.nsites):
            ...
            # calclulate maf of "N" masked bases
    ...
    # private functions that are called withn other functions
    ...
    def filter(self, minmaf, maxmissing):
        ...
        maxmissing: float
            The maximum prop. missing data. Filter columns with proportion Ns >
            this.
        """
    ...
    def filter_seqlib(self, minmaf, maxmissing):
        """
        Applies maf and missing filters to the array and returns a copy of the
        seqlib object where the .seqs array has been filtered
